    ...
    return (
        <section className="bg-gray-800 border border-gray-700 rounded-lg p-10 space-y-6 mx5">
            <section className="flex justify-between items-center">
                ...
                <button aria-label="show-favorites-button" onClick={onShowFavorites} className="flex gap-2 items-center justify-center font-semibold rounded-lg transition-colors duration-200 cursor-pointer border-2 px-4 py-2 text-sm border-orange text-orange">
                    <FaHeart size={15} />
                    Favorites
                </button>
            </section>
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-5">
                <div className="space-y-1">
                    ...
                    >
                        <option aria-label="status-option" value="">All</option>
                        <option aria-label="status-option" value="Alive">Alive</option>
                        <option aria-label="status-option" value="Dead">Dead</option>
                        <option aria-label="status-option" value="Unknown">Unknown</option>
                    </select>
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                    ...
                    <button aria-label="sort-button" onClick={toggleSort} className="flex justify-between items-center font-medium rounded-lg transition-colors duration-200 cursor-pointer border-2 border-mint text-mint hover:bg-mint hover:text-dark px-3 py-1.5 text-sm w-full">
