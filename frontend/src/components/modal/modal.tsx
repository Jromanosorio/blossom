...
function Modal({ selectedCharacter, onHandleFavorite, onSubmitComment, onClose }: ModalProps) {
  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
      ...
      <div className='animationZoomIn relative w-full bg-gray-800 dark:bg-gray-800 rounded-md shadow-xl max-w-2xl max-h-[90vh] mx-5 px-10 py-5 overflow-y-auto border-2 border-gray-700'>
