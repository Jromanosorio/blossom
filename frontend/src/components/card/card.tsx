...
function Card(props: CardProps) {
    return (
        <article className="relative bg-gray-800 border rounded-md overflow-hidden border-gray-700 group" style={{ opacity: 0, animation: "fadeIn 1s ease-out forwards", animationDelay: `${props.id * 100}ms` }}>
